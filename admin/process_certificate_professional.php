...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'], $_POST['action'])) {
    ...
    $safeName = preg_replace('/[^A-Za-z0-9_\-]/', '_', strtolower($fullName)); // clean filename
    ...
    $fileName = "certificate_professional_" . $safeName . ".pdf";
    ...
    if ($action === "generate") {
        ...
        $pdf->SetTextColor(60, 60, 60);
        $pdf->Cell(278, 10, $designation, 0, 1, "C");
...
elseif ($action === "edit") {
    ...
    // --- Follow-up: handle email notifications ---
